# [Riot 搜索引擎](https://github.com/hhjpin/riot)
...
[![Go Report Card](https://goreportcard.com/badge/github.com/hhjpin/riot)](https://goreportcard.com/report/github.com/hhjpin/riot)
[![GoDoc](https://godoc.org/github.com/hhjpin/riot?status.svg)](https://godoc.org/github.com/hhjpin/riot)
[![GitHub release](https://img.shields.io/github/release/go-ego/riot.svg)](https://github.com/hhjpin/riot/releases/latest)
...
* 支持[逻辑搜索](https://github.com/hhjpin/riot/blob/master/docs/zh/logic.md)
...
* 支持 heartbeat
* 支持[分布式索引和搜索](https://github.com/hhjpin/riot/tree/master/data)
* 可实现[分布式索引和搜索](/docs/zh/distributed_indexing_and_search.md)
* 采用对商业应用友好的[Apache License v2](/LICENSE)发布

* [查看分词规则](https://github.com/hhjpin/riot/blob/master/docs/zh/segmenter.md)
<!-- 
Riot v0.10.0 was released in Nov 2017, check the [Changelog](https://github.com/hhjpin/riot/blob/master/docs/CHANGELOG.md) for the full details. -->
...
```
go get -u github.com/hhjpin/riot
```
...
func main() {
	...
	searcher.Init(types.EngineOpts{
		Using:             3,
		GseDict: "zh",
		// GseDict: "your gopath"+"/src/github.com/hhjpin/riot/data/dict/dictionary.txt",
	})
...
#### [查看更多例子](https://github.com/hhjpin/riot/tree/master/examples)

#### [持久化的例子](https://github.com/hhjpin/riot/blob/master/examples/store/main.go)
#### [逻辑搜索的例子](https://github.com/hhjpin/riot/blob/master/examples/logic/main.go)

#### [拼音搜索的例子](https://github.com/hhjpin/riot/blob/master/examples/pinyin/main.go)

#### [不同字典和语言例子](https://github.com/hhjpin/riot/blob/master/examples/dict/main.go)

#### [benchmark](https://github.com/hhjpin/riot/blob/master/examples/benchmark/benchmark.go)

#### [Riot 搜索模板, 客户端和字典](https://github.com/hhjpin/riot/tree/master/data)
...
* [Contributors](https://github.com/hhjpin/riot/graphs/contributors)
